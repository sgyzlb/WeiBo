...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    NSDictionary *attributesLabel = @{NSFontAttributeName:kRetweetScreenNameFont};
    CGSize labelSize = [label.text sizeWithAttributes:attributesLabel];
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    NSDictionary *attributesDetail = @{NSFontAttributeName:detailsLabelFont};
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading attributes:attributesDetail context:nil].size;
